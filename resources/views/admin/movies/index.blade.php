                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="text-sm divide-y divide-gray-800/50">
                        ...
                        <tr class="hover:bg-gray-800/20 transition">
                            ...
                            <td class="p-4 text-center">
                                <div class="flex items-center justify-center space-x-2">                                        <a href="{{ route('admin.movies.edit', $movie->id) }}" class="text-gray-400 hover:text-white bg-gray-800 p-2 rounded transition border border-gray-700 hover:border-gray-500 inline-block">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/></svg>
                                        </a>                                                                        <button class="text-gray-400 hover:text-red-500 bg-gray-800 p-2 rounded transition border border-gray-700 hover:border-red-500/50">
